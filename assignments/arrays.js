...
console.log("Challenge 1: ", `Car 33 is a ${inventory[32].car_year} ${inventory[32].car_make} ${inventory[32].car_model}.` );
...
let lastCar = 0;
console.log("Challenge 2: ", `The last car in the inventory is a ${inventory[inventory.length-1].car_year} ${inventory[inventory.length-1].car_make} ${inventory[inventory.length-1].car_model}.` );
...
let carModels = inventory.map(function(a) { return a.car_model});
...
console.log("Challenge 4: ", carYears);

// ==== Challenge 5 ====
// The car lot manager needs to find out how many cars are older than the year 2000. Using the carYears array you just created, find out how many cars were made before the year 2000 by populating the array oldCars and logging it's length.

oldCars = carYears.filter(a => a < 2000);
